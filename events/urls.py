...
urlpatterns = [
    ...
    path('edit-showtime/<int:showtime_id>/', views.edit_showtime,
         name='edit_showtime'),
    path('delete-event/<int:event_id>/', views.delete_event,
         name='delete_event'),
    path('delete-venue/<int:venue_id>/', views.delete_venue,
         name='delete_venue'),
    path('delete/<int:showtime_id>/', views.delete_showtime,
